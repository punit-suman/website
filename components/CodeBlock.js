...
>  `
    ...
    useEffect(() => {
        if (startLine2) {
            var s = code
            setTimeout(() => {s = s + newLine; setCode(s); addLine(s, line2, 1, line1.length, setStartLine2, setStartLine3);}, 1000)
        }
    }, [startLine2])
    useEffect(() => {
        if (startLine3) {
    ...
    useEffect(() => {
        if (startLine4) {
            var s = code
            setTimeout(() => {s = s + newLine; setCode(s); setShowLoaderCursor(true); setTimeout(() => {setShowLoaderCursor(false); s = s + newLine; setCode(s); addLine(s, line4, 5, (line1 + line2 + line3).length, setStartLine4, setStartLine5);}, 5000)}, 1000)
        }
    }, [startLine4])
    useEffect(() => {
        if (startLine5) {
            var s = code
            setTimeout(() => {s = s + newLine; setCode(s); addLine(s, line5, 6, (line1 + line2 + line3 + line4).length, setStartLine5, setStartLine6);}, 1000)
        }
    }, [startLine5])
    useEffect(() => {
        if (startLine6) {
            var s = code
            setTimeout(() => {s = s + newLine; setCode(s); addLine(s, line6, 7, (line1 + line2 + line3 + line4 + line5).length, setStartLine6, null);}, 1000)
        }
    }, [startLine6])
    return (
